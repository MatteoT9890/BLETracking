...
public class BDAddr {
	...
	/**
	 * Crea il BDAddr dal MAC esadecimale formattato
	 * @param addr è l'indirizzo MAC, formattato
	 * @return ritorna l'oggetto BDAddr, il cui MAC è in byte (little-endian)
	 */
